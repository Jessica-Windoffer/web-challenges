...
– [x] When the slider control of inputColor is moved, change the background color of the box. 
...
– [ ] When the slider control of inputRotation is moved, rotate the box.
      Hint: You may need to work with the CSS property "transform" and a value that contains 
      "rotate" and "deg".
